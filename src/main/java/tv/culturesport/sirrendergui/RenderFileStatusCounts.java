...
public class RenderFileStatusCounts {
     ...
     */
    public RenderFileStatusCounts(String fileName, String renderStatus, String currentFile,
            int frameStart, int frameEnd, int frameCount, int currentFrame, int renderFrameCount, 
            int renderDefaultHangTime, int masterSlavePriority) 
    {
